...
#ifndef IOTJS_MODULE_SMART_THINGS_SET_MESSAGE_H
#define IOTJS_MODULE_SMART_THINGS_SET_MESSAGE_H
...
typedef struct {
  ...
  st_things_set_request_message_s* msg;
  jerry_value_t jrep;
} iotjs_sthings_set_message_t;
